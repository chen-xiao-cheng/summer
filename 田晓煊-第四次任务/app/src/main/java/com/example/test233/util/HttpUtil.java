package com.example.test233.util;

import com.example.test233.CallBcak;
...
public class HttpUtil {
    public static void GetHttpString(HttpBean httpBean, CallBcak callBcak) {
        Map<String,String> map = httpBean.getMap();
        String methon = httpBean.getMehton();
